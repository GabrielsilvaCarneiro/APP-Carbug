...
const BemVindoScreen = () => {
  ...
  const [modalWidth, setModalWidth] = useState('95%'); // Largura padrão do modal
  ...
  const handleRegister = () => {
    ...
    if (!confirmPass(password)) {
      setModalWidth('95%');
      setErrorMessage({ title: 'Confirme as suas Senhas!', message: 'insira uma senha valida.' });
      setErrorModalVisible(true);
      return;
    }

    // Mostra mensagem de sucesso e navega após o fechamento do modal
    setSuccessMessage({ title: 'Bem-vindo!', message: 'Seja Bem-vindo(a) de volta!' });
    ...
    >
        ...
        <View style={styles.centeredView}>
          <View style={[styles.modalView, { width: modalWidth }]}>
            <View style={styles.iconContainer}>
              <Icon name="error" size={30} color="#F00" />
            </View>
            <View>
      ...
      >
        <View style={styles.centeredView}>
          <View style={[styles.modalView, { width: modalWidth }]}>
            <View style={styles.iconContainer}>
              <Icon name="check" size={30} color="#190" />
            </View>
            <View>
