...
const comments = [
  {
    id: '1',
    name: 'Kauã Lima',
    comment: 'Agora eu sei o que fazer quando embassar o vidro',
    time: 'há 11 Minutos',
  },
  {
    id: '2',
    name: 'Gabriel Miguel',
    comment: 'Não vi muita diferença mas ajudou',
    time: 'há 4h',
  },
  {
    id: '3',
    name: 'Francisco',
    comment: 'Super ajudou',
    time: 'há 2 Semanas',
        ...
        <>
          <View style={styles.carImageWrapper}>
            <View style={styles.carImageContainer}>
              <Image style={styles.carImage} source={require('@/assets/images/ParabrisaFR.png')} />
            </View>
          </View>
          <View style={styles.separator} />
        </>
    ...
    if (item.type === 'image') {
      return (
        <View style={styles.titleContainer}>
          <Text style={styles.title}>Desembaçar o Parabrisas</Text>
        </View>
      );
    }
        ...
        <>
          <View style={styles.helpSection}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <Text style={styles.helpTitle}>Problemas para limpar ou desembaçar o parabrisas do carro?</Text>
              <Icon name="car" size={20} color="#000" style={styles.icontext} />
            </View>
            <Text style={styles.helpText}>
              Desembaçar:

              Ligue o ventilador do carro direcionado para o para-brisas.
              Ajuste o ar para quente e ative o ar-condicionado se disponível.
              Abra levemente uma janela para equilibrar a umidade.
            </Text>
            <Text style={styles.helpText}>
              Limpeza:

              Use um limpador próprio para vidros automotivos.
              Seque com um pano de microfibra para evitar manchas.
            </Text>
          </View>
          <View style={styles.separator} />
        </>
    ...
    if (item.type === 'video') {
      return (
        <View style={styles.videoSection}>
          ...
          <TouchableOpacity onPress={() => Linking.openURL('https://www.youtube.com/watch?v=nWtJav9EYdw')} style={styles.videoPlaceholder}>
    ...
    if (item.type === 'comment') {
      return (
        <View style={styles.commentContainer}>
          ...
          {item.videoUri && (
            <TouchableOpacity onPress={() => Linking.openURL('https://www.youtube.com/watch?v=nWtJav9EYdw')} style={styles.videoPlaceholderComment}>
